 ...
 * Now, when you call <code>browser().navigateTo('memory.html')</code> in your scenario test, the browser will open /your-prefix/memory.html.
 * That matches the proxy, so JSTD will proxy this request to http://localhost:8000/memory.html.
 */
